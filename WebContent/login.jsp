...
<head>
<meta charset="utf-8">
<title>欢迎登录"茅庐网盘"</title>

<link href="https://cdn.bootcdn.net/ajax/libs/font-awesome/4.7.0/css/font-awesome.css" rel="stylesheet">

<link rel="icon"
	href="https://avatars.githubusercontent.com/u/93065034?v=4"
	type="image/x-icon">
		...
		<div class="form-container sign-up-container">
			<form action="RegistServlet" method="post">
				...
				<div class="social-container">
					...
					<a href="https://blog.csdn.net/m0_52832310?type=blog"	class="social"><i class="fa fa-link"></i></a> 
					<a href="https://github.com/wanghui1212" class="social"><i class="fa fa-github"></i></a>
				</div>
