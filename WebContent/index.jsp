...
<body class="container">
	...
	if (list.length != 0) {
		...
		*/
		result = list[0].getPath().getParent().toString().substring(51);
	} else {
		result = "";
	}
	%>
	<nav class="navbar navbar-expand-lg navbar-light bg-light mt-5">
		<a class="navbar-brand" href="#"><i
			class="fa fa-modx fa-spin m-1"></i>茅庐网盘
		</a>
	...
	<table class="table table-hover " style="text-align: center">
		<thead style=" background-color: #c7b25e;  color: white;">
			<tr>
				<th scope="col">序号</th>
				<th scope="col">文件名</th>
				<th scope="col">属性</th>
